...
public class HealthPersonWriter implements PersonWriter {
    ...
    public void writePersonExposure(String path) {
        ...
        pwp.print(",");
        pwp.print("severeFatalInjuryCar");
        pwp.print(",");
        pwp.print("severeFatalInjuryBike");
        pwp.print(",");
        pwp.print("severeFatalInjuryWalk");
        pwp.print(",");
        ...
        for (Person pp : householdData.getPersons()) {
            ...
            pwp.print(",");
            pwp.print(((PersonHealthMEL)pp).getWeeklyAccidentRisk("severeFatalInjuryCar"));
            pwp.print(",");
            pwp.print(((PersonHealthMEL)pp).getWeeklyAccidentRisk("severeFatalInjuryBike"));
            pwp.print(",");
            pwp.print(((PersonHealthMEL)pp).getWeeklyAccidentRisk("severeFatalInjuryWalk"));
            pwp.print(",");
